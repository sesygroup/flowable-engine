...
angular.module('flowableModeler')
  .controller('ChoreographiesCtrl', ['$rootScope', '$scope', '$translate', '$http', '$timeout','$location', '$modal', function ($rootScope, $scope, $translate, $http, $timeout, $location, $modal) {

      // Main page (needed for visual indicator of current page)
      $rootScope.setMainPageById('choreographies');
	  ...
	  $scope.createProcess = function(mode) {
	    var modalInstance = _internalCreateModal({
	        template: 'views/popup/choreography-create.html?version=' + Date.now()
	    }, $modal, $scope);
	  };

	  $scope.importProcess = function () {
          _internalCreateModal({
              template: 'views/popup/choreography-import.html?version=' + Date.now()
          }, $modal, $scope);
	  };
...
angular.module('flowableModeler')
.controller('CreateNewChoreographyCtrl', ['$rootScope', '$scope', '$modal', '$http', '$location',
...
angular.module('flowableModeler')
.controller('DuplicateChoreographyCtrl', ['$rootScope', '$scope', '$modal', '$http', '$location',
                                          function ($rootScope, $scope, $modal, $http, $location) {
...
angular.module('flowableModeler')
.controller('ImportChoreographyCtrl', ['$rootScope', '$scope', '$http', 'Upload', '$location', function ($rootScope, $scope, $http, Upload, $location) {
